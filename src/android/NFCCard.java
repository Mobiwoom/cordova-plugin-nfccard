...
public class NFCCard extends CordovaPlugin {
    ...
    Log.d("Java action=",action);
     if (action.equals("setNFC")) {
              ...
              Boolean available = NFCCard.isNfcAvailable(cordova.getActivity().getApplicationContext());
              callbackContext.success(String.valueOf(available));
              return true;
           }  else if (action.equals("isNfcEnabled")) {
          
              Boolean enabled = NFCCard.isNfcEnabled(cordova.getActivity().getApplicationContext());             
              
              if (!enabled) {
              
                  AlertDialog.Builder alertbox = new AlertDialog.Builder(cordova.getActivity());
			            alertbox.setTitle("Info");
			            alertbox.setMessage("Please enable NFC and press back to return to this application.");
...
public void onNewIntent(final Intent intent) {
  ...
  /**
	...
	public static boolean isNfcEnabled(final Context pContext) {
		...
		try {
      Log.d("pepe", "checking NFC enabled");
			NfcAdapter adapter = NfcAdapter.getDefaultAdapter(pContext);
